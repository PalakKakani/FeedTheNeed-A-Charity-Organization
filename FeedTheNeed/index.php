        ...
        <div id="content">
            ...
            <div class="container">
                <div class="row text-center" style="width:100%;">
                    <div class="col-sm-3" style="margin-right:50px; margin-left:100px;">                       
                            <div class="thumbnail" style="border-color:transparent;">
                                <img src="img/Vishal_Nannore.avif" alt="" style="width:100%;">
                                <div class="caption">
                                    <h3>VISHAL NANNORE</h3>
                                </div>
                            </div> 
                    </div>
                    <div class="col-sm-3" style="margin-right:50px;">                       
                            <div class="thumbnail" style="border-color:transparent;">
                                <img src="img/Srushti_Khatri.avif" alt="" style="width:100%;">
                                <div class="caption">
                                    <h3>SRUSHTI KHATRI</h3>
                                </div>
                            </div> 
                    </div>
                    <div class="col-sm-3" style="margin-right:80px;">                       
                            <div class="thumbnail" style="border-color:transparent;">
                                <img src="img/Palak_Kakani.avif" alt="" style="width:100%;">
                                <div class="caption">
                                    <h3>PALAK KAKANI</h3>
                                </div>
                            </div> 
            ...
            <div id="contact" style="margin-top:10px;background-color:#1B1E23;">
              <div class="container">
                  ...
                  <div class="col-sm-6">
                      <h2 style="color:#D4AF37;font-size:25px;">FeedTheNeed</h2>
                  ...
                  <div class="col-sm-6">
                      ...
                      <div class="thumbnail" style="background-color:#1B1E23;color:white;border-color:#1B1E23;">
                      <p class="fa fa-google" style="font-size:20px;">  feedtheneed@gmail.com</p><br>
